...
class DownstreamTaskCallback(pl.Callback):
    ...
    def _run_linear_probe_subprocess(self, artifact_ref: str, current_epoch: int) -> None:
        ...
        try:
            ...
            script_path = Path(__file__).parent.parent / "scripts" / "train_classification.py"
